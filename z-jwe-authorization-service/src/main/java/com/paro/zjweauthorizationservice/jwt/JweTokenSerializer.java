package com.paro.zjweauthorizationservice.jwt;
...
//Payload Encryption
//JWE - JWT with encrypted payload
public class JweTokenSerializer {
    ...
    public Map<String, Object> decode(String base64EncodedKey, String content) {
        try {
            ...
            return reader.with(DeserializationFeature.USE_LONG_FOR_INTS).readValue(jwe.getPayload().toString());
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
