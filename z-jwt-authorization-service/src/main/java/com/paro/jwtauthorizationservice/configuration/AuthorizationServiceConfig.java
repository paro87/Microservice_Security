...
public class AuthorizationServiceConfig extends AuthorizationServerConfigurerAdapter {
    ...
    public AuthorizationServiceConfig(DataSource dataSource, PasswordEncoder passwordEncoder, AuthenticationManager authenticationManager, AdditionalClaimsTokenEnhancer tokenEnhancer) {
