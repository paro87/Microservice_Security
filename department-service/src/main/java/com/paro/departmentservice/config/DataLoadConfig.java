    ...
    public CommandLineRunner dataLoader(DepartmentRepository departmentRepository) {
        return new CommandLineRunner() {
            ...
            public void run(String... args) throws Exception {
                departmentRepository.add(new Department(11L, "Cardiology", 1L, null));
                departmentRepository.add(new Department(12L, "Neurology", 1L, null));
                departmentRepository.add(new Department(13L, "Oncology", 1L, null));
