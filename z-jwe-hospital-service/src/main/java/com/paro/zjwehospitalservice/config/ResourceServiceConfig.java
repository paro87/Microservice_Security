package com.paro.zjwehospitalservice.config;

import com.paro.zjwehospitalservice.jwt.JweTokenSerializer;
import com.paro.zjwehospitalservice.jwt.JweTokenStore;
...
//        http.authorizeRequests().anyRequest().permitAll();
    ...
    public JweTokenStore tokenStore() {
        return new JweTokenStore(getSignKey(), new JwtTokenStore(jwtTokenConverter()), jwtTokenConverter(), tokenSerializer());
    }
    ...
    public String getSignKey() {
        ...
        return (String) Objects.requireNonNull(keyUriRestTemplate.exchange(url, HttpMethod.GET, request, Map.class).getBody()).get("value");
    }
